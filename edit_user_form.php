...
<head>
    ...
    <title>Update User - StressSense Admin</title>
        ...
        <div class="bg-white/90 backdrop-blur rounded-xl shadow-lg border border-blue-100/70 overflow-hidden">
            <div class="p-4 border-b border-gray-200">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <h2 class="text-xl font-bold text-blue-700 mb-2 md:mb-0">Edit User Account</h2>
                </div>
            </div>
            ...
            <div class="p-4">
                ...
                <form method="POST" action="edit_user_form.php" class="space-y-4">
